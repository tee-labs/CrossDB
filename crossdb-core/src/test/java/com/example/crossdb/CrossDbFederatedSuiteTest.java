...
class CrossDbFederatedSuiteTest {
  ...
  class PostgresRegression {
    ...
    @Test
    void caseSearchedNested() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void betweenSymmetricKeyword() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void notBetweenExcludes() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void likeSingleCharWildcard() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void likeEscapeClause() throws Exception {
    ...
    @Test
    void substringFullForms() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void trimBothCustomChars() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void nullifEqualNulls() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void notInWithNullSubqueryIsEmpty() throws Exception {
    ...
    @Test
    void notInWithoutNullWorks() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void integerVsDecimalDivision() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void roundHalfAwayFromZero() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void concatNullPropagates() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void explicitNullsOrdering() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void scalarSubqueryEmptyIsNull() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void existsCorrelatedAggregate() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("bob"), rows(db,
    ...
    @Test
    void intersectBindsTighterThanUnion() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void extractYearMonth() throws Exception {
    ...
    @Test
    void orderByMultiKeyMixedDirection() throws Exception {
      try (CrossDb db = core()) {
  ...
  class MysqlDialectSuite {
    ...
    @Test
    void concatWsSkipsNulls() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void limitOffsetCommaForm() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void backtickQuotedIdentifiers() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void modDecimalColumnUsesFloatSemantics() throws Exception {
    ...
    @Test
    void modIntegerColumnStaysNative() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void divOperatorOnColumns() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void bitwiseOnColumns() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("1", "2"), rows(db,
    ...
    @Test
    void bitwiseShiftAndPrecedence() throws Exception {
      // MySQL 优先级：算术 > 位移 > & > |
      try (CrossDb db = core()) {
    ...
    @Test
    void logTwoArgBase() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void locateNotFoundZero() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void locateStartBelowOne() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("0"), rows(db,
    ...
    @Test
    void leftRightOnColumns() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void leftEdgeLengths() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void strcmpNullPropagation() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void concatWithSpaceNullPropagates() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("NULL"), rows(db,
    ...
    @Test
    void charChrEquivalence() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("A,B"), rows(db,
    ...
    @Test
    void yearMonthFunctions() throws Exception {
      try (CrossDb db = goods()) {
    ...
    @Test
    void straightJoinWithFilter() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void castBooleanLiteralsRegression() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("1,0,1"), rows(db,
    ...
    @Test
    void castBooleanColumnRegression() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void fetchPercentVariants() throws Exception {
  ...
  class TrinoFederated {
    ...
    @Test
    void crossDbJoinOnEqualTypedKeys() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void countDistinctAcrossUnion() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void threeWayUnionShardTopN() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void bindJoinPushdownShapeRecording() throws Exception {
    ...
    @Test
    void fullOuterJoinAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void correlatedScalarSubqueryCrossDb() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void lateralCorrelatedCrossDb() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("alice,2", "bob,2", "carol,0"), rows(db,
    ...
    @Test
    void existsSemiAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void notExistsAntiAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void usingJoinAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void windowOverCrossDbJoinAggregate() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void inSubqueryWithAggregateAcrossDb() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("bob"), rows(db,
    ...
    @Test
    void orderByOverUnionWithNulls() throws Exception {
      try (CrossDb db = all()) {
  ...
  class DuckDbModern {
    ...
    @Test
    void qualifyWithPartitionWindow() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void positionInForm() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void stringAggDistinctSorted() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void firstValueDefaultFrame() throws Exception {
      try (CrossDb db = core()) {
  ...
  class ShardingSphereMerge {
    ...
    @Test
    void shardTopNOrderByAsc() throws Exception {
      try (CrossDb db = all()) {
        assertEquals(List.of("1", "1", "2"), rows(db,
            "SELECT id FROM userdb.users UNION ALL SELECT id FROM eventdb.events "
                + "ORDER BY id LIMIT 3"));
    ...
    @Test
    void shardTopNOrderByDesc() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void shardBranchesCarryLimitRecording() throws Exception {
    ...
    @Test
    void aggregateMergeOverUnionAll() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void unionDistinctMergeCorrectness() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void unionAllHavingFilter() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void mirrorShardSelfJoin() throws Exception {
      try (CrossDb db = goods()) {
    ...
    @Test
    void sumOfSumsOverShards() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void windowOverMergedShards() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void exceptAfterUnion() throws Exception {
      try (CrossDb db = all()) {
        assertEquals(List.of("2"), rows(db,
    ...
    @Test
    void intersectAcrossDbs() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("1", "2"), rows(db,
    ...
    @Test
    void paginationThroughUnion() throws Exception {
      try (CrossDb db = all()) {
        assertEquals(List.of("2"), rows(db,
            "SELECT id FROM userdb.users UNION ALL SELECT id FROM eventdb.events "
    ...
    @Test
    void caseAggregateOverShardUnion() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void semiJoinOverUnionAll() throws Exception {
      try (CrossDb db = all()) {
        assertEquals(List.of("1"), rows(db,
    ...
    @Test
    void groupByTwoKeysOverUnion() throws Exception {
      try (CrossDb db = all()) {
  ...
  class TpcShapes {
    ...
    @Test
    void tpchQ1AggregateCaseOverJoin() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void tpchQ3ThreeWayJoinTopN() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void tpchQ13LeftJoinGrouped() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("alice,2", "bob,2", "carol,0"), rows(db,
    ...
    @Test
    void tpchQ18AllQuantifiedSubquery() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void tpchQ21NotExistsPair() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("alice"), rows(db,
    ...
    @Test
    void windowRankPerCustomer() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void ratioToReportPerOrder() throws Exception {
      try (CrossDb db = core()) {
...
@Test
    ...
    @Test
    void coalesceDimensionFill() throws Exception {
      try (CrossDb db = goods()) {
    ...
    @Test
    void returnFlagStyleGrouping() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void explainShowsBindJoinOnTpcShape() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void correlatedExistsAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
  ...
  class SqlStandardConformance {
    ...
    @Test
    void isDistinctFromNullSafe() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void isNotDistinctFromJoinKey() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void nullifPair() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void exceptAllMultisetSemantics() throws Exception {
    ...
    @Test
    void intersectAllMultisetSemantics() throws Exception {
      try (CrossDb db = all()) {
        assertEquals(List.of("1"), rows(db,
    ...
    @Test
    void valuesDerivedJoinWithColumnList() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void cteChainThreeLevels() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("1", "2"), rows(db,
    ...
    @Test
    void cteReferencedTwice() throws Exception {
      try (CrossDb db = core()) {
        assertEquals("2", scalar(db,
    ...
    @Test
    void rowConstructorInList() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("100", "101"), rows(db,
    ...
    @Test
    void castRoundTripMatrix() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void betweenWithExpressionBounds() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("100", "101", "102"), rows(db,
    ...
    @Test
    void similarToAlternation() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void threeValuedLogicMatrix() throws Exception {
      try (CrossDb db = core()) {
  ...
  class OracleMssqlDialect {
    ...
    @Test
    void decodeNullEqualSemantics() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void decodeWithDefault() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void iifNested() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void topNRegression() throws Exception {
      try (CrossDb db = core()) {
        assertEquals(List.of("100", "101"), rows(db,
    ...
    @Test
    void isnullNestedChain() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void nvlTwoArg() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void addMonthsDate() throws Exception {
      try (CrossDb db = goods()) {
    ...
    @Test
    void monthsBetweenWholeMonths() throws Exception {
      try (CrossDb db = goods()) {
        assertEquals(List.of("2"), rows(db,
    ...
    @Test
    void datePlusMinusDaysRegression() throws Exception {
      try (CrossDb db = goods()) {
    ...
    @Test
    void groupsFrameFollowUpShapes() throws Exception {
    ...
    @Test
    void matchRecognizeFollowUpShapes() throws Exception {
    ...
    void matchRecognizeAlternationCandidate() throws Exception {
      // PATTERN 或语法 A | B（SQL:2011）：单行变体匹配 INFO 或 ERROR 行 →
      // 行 1、3、4 三个单行匹配（默认 SKIP PAST LAST ROW）
      try (CrossDb db = all()) {
    ...
    void connectByCandidate() throws Exception {
      // Oracle 层次查询（递归 CTE 等价改写）：自根（mgr_id IS NULL）下行全树
      try (CrossDb db = core()) {
  ...
  class EngineHardening {
    ...
    @Test
    void rowLimitExactlyAtThresholdPasses() throws Exception {
    ...
    @Test
    void rowLimitExceededThrows() throws Exception {
      try (CrossDb db = new CrossDb(1000, 2, 1, 1)
          .register("userdb", Fixtures.USERS)
          .register("orderdb", Fixtures.ORDERS)) {
    ...
    @Test
    void safeModeMatrix() throws Exception {
    ...
    @Test
    void readOnlyRejectsDmlAndDdl() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void readOnlyAllowsCteAndSetOps() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void explainContainsPhysicalOperators() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void analyzeReportsPushedSqlAndRows() throws Exception {
      try (CrossDb db = core()) {
    ...
    @Test
    void resultSetTypedGettersAcrossDbs() throws Exception {
      try (CrossDb db = all()) {
    ...
    @Test
    void cancelWithoutInflightIsNoop() throws Exception {
      try (CrossDb db = core()) {
        db.cancel();
    ...
    @Test
    void fetchSizePropagatesToSource() throws Exception {
      List<String> sqls = new ArrayList<>();
      List<String> props = new ArrayList<>();
    ...
    @Test
    void queryTimeoutPropagatesToSource() throws Exception {
      List<String> sqls = new ArrayList<>();
      List<String> props = new ArrayList<>();
